...
\Keywords{Modalidad Virtual, Deserción, Vista Minable, Minería de datos} % Keywords - if you don't want any simply remove all the text between the curly brackets
